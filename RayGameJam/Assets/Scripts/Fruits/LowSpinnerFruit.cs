...
public class LowSpinnerFruit : MonoBehaviour
{
    public MeshRenderer myRend;
    public float lifeDistance = 1;
    public float lowerMultiply;
    ...
    void OnCollisionEnter(Collision colleisson)
    {
        ...
        {
            colleisson.gameObject.GetComponent<PlayerGuy>().SetRotateSpeed(lowerMultiply, duration);
